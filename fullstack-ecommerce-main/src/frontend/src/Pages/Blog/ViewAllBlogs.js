...
function ViewAllBlogs(props) {
  let blogArray = [
    ...
    {
      title: "What Customers Are Saying About Switching from Disposable Vapes to Bundle Kits",
      description: `
    <p style="font-size: 16px; margin-bottom: 15px;">
  ...
  <footer style="margin-top: 30px; padding: 20px; background-color: #2c3e50; color: #ecf0f1; border-radius: 8px; text-align: center;">
    ...
    {
      title:
        "Vape Planet UK Backs the Call for a Vape Retailer Licensing Scheme",
      description: `
      <!-- Header Section -->
