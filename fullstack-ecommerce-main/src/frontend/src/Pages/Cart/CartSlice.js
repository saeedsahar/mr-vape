...
export const cartSlice = createSlice({
  ...
  reducers: {
    ...
    addItemQuantity : (state , action) => {
        ...
        let itemIndex = state.items.findIndex(ele => ele.id == action.payload.id)
...
export const { openCart, removeItem, addItemQuantity, decreaseItemQuantity, incrementItemQuantity } = cartSlice.actions
